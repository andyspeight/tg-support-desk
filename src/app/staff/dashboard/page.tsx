...
export default async function DashboardPage() {
  ...
  if (!session || !env.ownerEmails.includes(session.email)) redirect("/staff/home");
  ...
  return (
    <div className="mx-auto max-w-5xl p-4 sm:p-6">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <StatCard label="Open tickets" value={String(stats.open)} href="/staff/inbox?view=open" />
        <StatCard label="Needs a human" value={String(stats.escalated)} href="/staff/inbox?view=escalated" />
        <StatCard label="Waiting on customer" value={String(stats.waiting)} href="/staff/inbox?view=waiting" />
        <StatCard label="Breaching SLA" value={String(stats.breaching)} href="/staff/inbox?view=breaching" />
        ...
        />
        <StatCard label="KB published · in review" value={`${stats.kb.published} · ${stats.kb.review}`} href="/staff/kb" />
      </div>
