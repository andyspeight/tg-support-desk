...
export const ROADMAP: RoadmapStage[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Curate 171-article review queue", status: "in_progress", note: "in /kb" },
      { label: "~10 hand-written top-intent how-tos", status: "todo" },
      { label: "Eval set to 10 real cases, suite green", status: "todo" },
      { label: "Security checklist pass (brief §10)", status: "todo" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "CC + multi-recipient handling", status: "todo" },
      { label: "Attachments (allowlist, caps, signed URLs)", status: "todo" },
      { label: "Spam controls", status: "todo" },
      { label: "Global search", status: "todo" },
      { label: "Merge tickets", status: "todo" },
      { label: "Bulk actions + keyboard triage", status: "todo" },
      { label: "Collision detection + realtime inbox", status: "todo" },
      { label: "AI triage auto-tagging (intent / priority / language)", status: "todo" },
      { label: "Canned-response + tag management UI", status: "todo" },
  ...
  },
  {
    ...
    items: [
      { label: "CSAT one-tap surveys (gates the headline metric)", status: "todo" },
      { label: "Analytics v1 — true resolution rate, intent, SLA, Pareto", status: "todo" },
      { label: "SLA engine + business hours + breach view", status: "todo" },
  ...
  },
  {
    ...
    items: [
      { label: "Supplier error feed API → get_integration_errors", status: "todo" },
      { label: "validate_deeplink against official spec", status: "todo" },
      ...
      { label: "Self-improvement loop + weekly gap digest", status: "todo" },
      { label: "Eval ≥50 cases + CI gate", status: "todo" },
      { label: "Public KB portal with AI deflection", status: "todo" },
    ],
  },
  {
    id: 5,
