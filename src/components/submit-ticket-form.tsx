...
export function SubmitTicketForm({ action }: { action: (input: unknown) => Promise<SubmitResult> }) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4 rounded-2xl border border-line bg-surface p-6 shadow-[0_20px_45px_-25px_rgba(27,43,91,0.4)] sm:p-7">
      ...
      >
        {loading && <Loader2 className="h-4 w-4 animate-spin motion-reduce:animate-none" strokeWidth={2} />}
